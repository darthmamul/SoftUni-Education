namespace SIS.Framework.Services
{
    ...
    public class DependencyContainer : IDependencyContainer
    {
        ...
        private Type this[Type key] => this.dependencyMap.ContainsKey(key) ? this.dependencyMap[key] : null;
        ...
        public object CreateInstance(Type type)
        {
            ...
            {
                throw new InvalidOperationException($"Type {typeInstance.FullName} cannot be instantiated.");
            }
            ...
            {
                constructorParametersObjects[index] = this.CreateInstance(constructorParameters[index].ParameterType);
            }
