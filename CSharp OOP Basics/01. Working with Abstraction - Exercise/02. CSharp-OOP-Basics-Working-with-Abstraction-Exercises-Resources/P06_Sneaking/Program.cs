            ...
            for (int row = 0; row < room.Length - 1; row++)
            {
                ...
                for (int col = 0; col < currentRow.Length; col++)
                {
                    if (currentRow[col] == 'S')
                    {
                        ...
                        {
                            int nikoladzeIndex = Array.IndexOf(nextRow, 'N');
                            nextRow[nikoladzeIndex] = 'X';
            ...
            for (int row = 1; row < room.Length; row++)
            {
                ...
                for (int col = 0; col < currentRow.Length; col++)
                {
                    if (currentRow[col] == 'S')
                    {
                        ...
                        {
                            int nikoladzeIndex = Array.IndexOf(previousRow, 'N');
                            previousRow[nikoladzeIndex] = 'X';
                            Console.WriteLine("Nikoladze killed!");
                            PrintRoom();
                            Environment.Exit(0);
                        }
